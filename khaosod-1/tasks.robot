...
All
    ...
    FOR    ${count}    IN RANGE    1    11
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/around-thailand
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[3]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Execute Javascript    window.scrollTo(0,document.body.scrollHeight)
        ${contains}=    Does Page Contain Element
        ...    xpath:/html/body/main/article/div[2]/div[3]/div/div[1]/footer/div/ul/li[${count}]
        IF    ${contains}
            ${getcount}=    Get Element Count
            ...    xpath:/html/body/main/article/div[2]/div[3]/div/div[1]/footer/div/ul/li
            Log    ${getcount}
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/politics
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        Append To List    ${KhaosodAttribute}    ${attribute}
        ${image}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a/img
        ...    src
        Append To List    ${KhaosodImage}    ${image}
        Execute Javascript    window.scrollTo(0,document.body.scrollHeight)
        Click Element    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]
        Sleep    3s
        ${Title}=    Get Text    xpath:/html/body/main/article/div[1]/div/div/h1
        Append To List    ${KhaosodTitle}    ${Title}
        ${Topic}=    Get Text    xpath:/html/body/main/article/div[1]/div/div/div[3]/div[1]/span
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/economics
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/around-the-world-news
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[3]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/royal-news
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[3]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/covid-19
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/entertainment
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
        ...
        Sleep    3s
    END
    Go To    https://www.khaosod.co.th/sports
    FOR    ${count}    IN RANGE    1    11
        ${attribute}=    Get Element Attribute
        ...    xpath:./html/body/main/div[4]/div[1]/div[1]/div[2]/div/div[${count}]/div/div[1]/div/a
        ...    href
    ...
    Write table to CSV    ${table}    Khaosod.csv    encoding=UTF-8-sig
